...
HUD over 30 days: **shoppers kept +$43,775.04 · merchants earned
+$32,076.94.** Margins are net of NYC rents (bakery $500, florist $350,
...
**Win/tie/loss (CI vs zero), honestly:** clear wins — boba, bakery, florist,
parking, bar (bar's CI floor is +0.35, a hair off zero). Small directional
positive with CI spanning zero (a TIE we do not claim) — fashion, vintage.
Small negative with CI spanning zero — vending's B0 leak, barbershop. One real
loss — the bodega (−5.84, the machine's quotes poaching its walk-in defectors,
...
the 4-venue `results.json` still reproduces byte-for-byte). Vending +3.01,
bodega −5.84, boba +336.45, fashion +20.47 are exactly the B1B2 numbers.
...
| B1B2 (4 venue)|        +$17,649.39 |          +$10,619.97 |
| **B5 (10 venue)** |    **+$43,775.04** |      **+$32,076.94** |
...
fashion lane ~11×; the current committed 4-venue HUD is +$17,649.39, which is
