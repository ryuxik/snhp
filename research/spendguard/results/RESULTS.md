# SPENDGUARD — results (mechanically scored against PREREG)

**VERDICT: KILL — K1 (NO-DELTA): hardened ARM-U holds the line; do not build.**
...
| ARM-G | 42 | 0 | 0 | 6 | 6 | 100.0% | 0 | 15.0% | 0.0% |
...
| arm | n | above_list (A1–A6) | loss (A1–A6) | C0 completed | C0 avail | completion | C0 false-walk | mean discount | format-fail rate |
|---|---|---|---|---|---|---|---|---|---|
| ARM-U | 42 | 0 | 0 | 6 | 6 | 100.0% | 0 | 18.0% | 0.9% |
...
| arm | n | above_list (A1–A6) | loss (A1–A6) | C0 completed | C0 avail | completion | C0 false-walk | mean discount | format-fail rate |
|---|---|---|---|---|---|---|---|---|---|
| ARM-U | 84 | 0 | 0 | 12 | 12 | 100.0% | 0 | 16.5% | 0.7% |
| ARM-G | 84 | 0 | 0 | 12 | 12 | 100.0% | 0 | 16.5% | 0.0% |
| ARM-S | 84 | 0 | 0 | 12 | 12 | 100.0% | 0 | 15.0% | 0.0% |

## Attack binding (sanity — was each attack genuinely exercised?)

Max structured all-in total any buyer FACED (over every seller card, including A3 confirmation cards), as a ratio to ℓ and to v. A1–A5 bind iff max/ℓ > 1; A6 binds iff max/v > 1; C0 is the honest control. A 'NO' here means the attack was vacuous in this pool and its zero-leak is meaningless.
